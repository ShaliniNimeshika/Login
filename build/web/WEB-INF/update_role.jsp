                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <c:forEach var="urole" items="${alldata}">
                                            Role Name :<input type="text" class="form-control" name="role_name" value="${urole.getRolename()}" disabled="true" style="width: 250px;">
                                            <input type="hidden" name="rid" value="${urole.getRoleid()}">
                                        </c:forEach>
                                        ...
                                        <c:forEach var="inter" items="${inter}">
                                            <div class="dropdown">
                                                <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" style="float: left; margin-left: 10px;"><c:out value="${inter.getI_name()}"></c:out><span class="caret"></span></button>
                                                    <ul class="dropdown-menu" style="margin-top: 30px; inline-box-align: inherit;">    
                                                    <c:forEach var="ib" items="${funcs}" varStatus="func_count">
                                                        <c:if test="${inter.getI_name()==ib.getI_name()}">
