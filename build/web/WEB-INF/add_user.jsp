                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <form class="form-signin" action="UserFunctions" method="post">
                                            ...
                                            <input type="password" class="form-control" name="password" placeholder="Auto Generating Password" minlength="6" disabled="true">
                                            <div class="row" style="height: 10px;"></div>
                                            <input type="text" class="form-control" name="email" placeholder="Email Address" maxlength="100" required>
                                            <div class="row" style="height: 10px;"></div>
                                            User Role &nbsp;&nbsp;&nbsp;:
